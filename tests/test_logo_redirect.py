...
class TestLogoRedirect:
    ...
    def test_logo_redirect_to_dzen_success(self, driver):
        ...
        print(f"Actual page title: {actual_title}")  # Debugging statement
        assert 'Дзен' in actual_title, f"Ожидаемый заголовок страницы 'Дзен' не найден. Фактический заголовок: {actual_title}"